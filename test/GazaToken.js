...
contract("GazaToken", function(accounts){
    ...
    it('Initializes the contract with the correct name', function(){
        return  GazaToken.deployed().then(function(instance){
            ...
            assert.equal(name, 'Gaza Token', "has the correct name");
            return tokenInstance.symbol();
        }).then(function(symbol){
            assert.equal(symbol, "GAZT", "has the correct symbol");
            return tokenInstance.standard();
        }).then(function(standard){
            assert.equal(standard, "Gaza Token v1.0", "has the correct standard");
        });
    })
    ...
    it('sets the total supply upon development.', function(){
        return GazaToken.deployed().then(function(instance){
            ...
            assert.equal(adminBalance.toNumber(), 1000000, "it allocate the inital supply")
        });
    });
    ...
    it("handles delegated token transfers", function(){
        return GazaToken.deployed().then(function(instance){
            ...
            // Try transferring something large than sender's balance
